...
def getTableNet():
    ...
    model.load_weights('models/table_net.h5')

    return model



image_path = "data/dataset/train_data/4.jpg"
...
im.save(output_folder + '/image.png')

im=tf.keras.preprocessing.image.array_to_img(table_mask_pred)
im.save(output_folder + '/table_mask_pred.png')

im=tf.keras.preprocessing.image.array_to_img(col_mask_pred)
im.save(output_folder + '/col_mask_pred.png')

img_org = Image.open(output_folder + '/image.png')
table_mask = Image.open(output_folder + '/table_mask_pred.png')
col_mask = Image.open(output_folder + '/col_mask_pred.png')
...
img_org.save(output_folder + '/output.png')

# pytesseract.pytesseract.tesseract_cmd = r'/usr/bin/tesseract'
text = pytesseract.image_to_string(Image.open(output_folder + '/output.png'), lang='eng' )
